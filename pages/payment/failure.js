                ...
                <Row>
                    <Col lg={12} className="mx-auto text-center">
                        <div className="card-su">
                            <div className="checkmark1" style={{ borderRadius: "200px", height: "200px", width: "200px", background: "#F8FAF5", margin: "0 auto" }}>
                                <i className="fa fa-times"></i>
                            </div>
                            <h2>Payment Unsuccessful</h2>
                            <p>We have not received your payment.<br></br> Please check your bank for confirmation.</p>
                        </div>
                    </Col>
